...
function Secretary() {
    return (
        <div>
            <div id="sidebar">
                <a className='links' href='Liste patient' > <img src={patient} alt='patient-icon' /> </a>
                <a className='links' href='Appointement' > <img src={calendar} alt='calendar-icon' /> </a>
                <a className='links' href='WaitingS' > <img src={waiting} alt='waiting-icon' /> </a>
                <a id='powerOff' href='Authentification' > <img src={PowerOff} alt='powerOff-icon' /> </a>
            </div>
            <div id='header'>
                ...
                <div id='container'>
                    <a id='add-patient' href='RecordS' > <img src={addPatient} alt="patient-icon-add" /> </a>
