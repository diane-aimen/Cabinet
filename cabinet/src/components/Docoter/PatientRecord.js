...
function Record() {
    return (
        <div>
            <div id="sidebar">
                <a className='links' href='Doctor Patient' > <img src={patient} alt='patient-icon' /> </a>
                <a className='links' href='AppointementD' > <img src={calendar} alt='calendar-icon' /> </a>
                <a className='links' href='Waiting' > <img src={waiting} alt='waiting-icon' /> </a>
